...
$(BUILD_DIR)/initrd.img: $(BUILD_DIR)/ramdisk/writer
	$(BUILD_DIR)/ramdisk/writer $(RES_DIR)/test test $(RES_DIR)/test2 test2 $(RES_DIR)/out1.rawx out1.rawx $(RES_DIR)/out2.rawx out2.rawx $(RES_DIR)/out3.rawx out3.rawx $(RES_DIR)/rawos_print.rawx rawos_print.rawx $(RES_DIR)/rawos_fork.rawx rawos_fork.rawx $(RES_DIR)/rawos_fork_2.rawx rawos_fork_2.rawx $(RES_DIR)/rawos_cursor.rawx rawos_cursor.rawx $(RES_DIR)/rawos_execve.rawx rawos_execve.rawx
